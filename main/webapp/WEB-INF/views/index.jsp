...
<div id="wrap"> 
  ...
  <!-- header-->
  <div id="header">
    <h1><a href="#"><img src="images/header/common/logo.gif" alt="서울학교급식포털" /></a></h1>
    <div class="topmenu">
      <ul>
      ...
      <ul>
        ...
        <li class="bn"> <a href="${path }/login.go"><img src="images/header/common/btn_login.gif" alt="로그인" /></a></li>
      </ul>
    </div>
    <div id="gnb">
      <h2>주메뉴</h2>
